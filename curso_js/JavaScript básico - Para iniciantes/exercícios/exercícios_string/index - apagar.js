...
console.log(string7.split('')); // separa todos os caracteres do texto

//-----------------------------------------------------------

let string9 = "O rato roeu a roupa do rei de Roma.";

console.log(string8.toUpperCase()); // converte todas as letras em maiúsculas
console.log(string8.toLowerCase()); // converte todas as letras em minúsculas
